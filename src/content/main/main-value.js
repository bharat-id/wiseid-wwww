        ...
        {data && data.map((item, i) => (
          <div className="col" key={i}>
            <div className="card h-100 border-none">
              <div className="">
                <img src={item.avtr} className="img-fluid w-100 rounded-wd" alt="..."></img>
              </div>
              
              <div className="card-body m-0">
                <h5 className="card-title fw-bold caption-sm text-color-main">{item.name}</h5>
                <div className="d-none d-md-block">
                  <p className="lead text-md">{item.text}</p>
                </div>
                <div className="d-md-none">
                  <p className="card-text text-md small">{item.text}</p>
                </div>
